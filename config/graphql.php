...
return [
    ...
    'types' => [
        ...
        'OrderEdge' => \App\GraphQL\Types\OrderEdgeType::class,
    'OrderConnection' => \App\GraphQL\Types\OrderConnectionType::class,
        'ShippingAddress' => App\GraphQL\Types\ShippingAddressType::class,
    ],
